...
def get_icon(icon_path, icon_name, size=None, color=None, extra_classes=None):
    ...
    try:
        ...
        if resp.status_code >= 400:
            # return f"Icon <{icon_path}> does not exist"
            return getattr(
                settings, "BS_ICONS_NOT_FOUND", f"Icon <{icon_path}> does not exist"
            )
...
def bs_icon(icon_name, size=None, color=None, extra_classes=None):
    ...
    base_url = getattr(
        settings,
        "BS_ICONS_BASE_URL",
        "https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.4/",
    )
...
def md_icon(icon_name, size=None, color=None, extra_classes=None):
    ...
    base_url = getattr(
        settings, "MD_ICONS_BASE_URL", "https://cdn.jsdelivr.net/npm/@mdi/svg@7.2.96/"
    )
